...
VALUES
('Instituto de Diagnóstico Mamário Recife', '12.345.678/0001-90',
 'Av. Boa Viagem, 1200 – Recife, PE', 'contato@idmrecife.org.br', '(81) 3344-5566'),

('Centro de Saúde Mulheres do Futuro', '98.765.432/0001-33',
 'Rua das Flores, 450 – Olinda, PE', 'mulheresfuturo@csf.org.br', '(81) 3556-8899');
...
VALUES
('Dra. Ana Paula Monteiro', 'ana.monteiro@idmrecife.org.br', 'hashsenha123',
 'CRM-PE 12345', 'Radiologista', 'MEDICO', 1, 1),

('Dr. Ricardo Alves', 'ricardo.alves@idmrecife.org.br', 'hashsenha456',
 'CRM-PE 67890', 'Mastologista', 'MEDICO', 1, 1),

('Mariana Souza', 'mariana.souza@idmrecife.org.br', 'hashsenha789',
 NULL, 'Tecnico em Radiologia', 'TECNICO', 1, 1),

('João Auditor', 'joao.auditor@csf.org.br', 'hashsenha101',
 NULL, 'Auditor Compliance', 'AUDITOR', 1, 2),

('Admin Sistema', 'admin@sistema.org.br', 'hashsenha202',
 NULL, 'Administrador', 'ADMIN', 1, 2);
...
VALUES
(1, 1, '/imagens/exame_mama_001_Ana.png',
 '2025-02-12 14:30:00', 'Exame mama esquerda - alta suspeita', 'Termografia'),

(2, 1, '/imagens/exame_mama_002_Ricardo.png',
 '2025-02-13 09:10:00', 'Lesão observada lateral direita', 'Termografia'),

(3, 1, '/imagens/exame_mama_003_Mariana.png',
 '2025-02-14 10:00:00', 'Imagem teste técnico', 'Termografia');
...
VALUES
(1, 1, '2025-02-12 15:00:00', '2025-02-12 15:01:30',
 'Maligno', 0.92, 'THERMO_AI_V2.4', 'A1B2C3D4', 'IMGHASH2025MAL'),

(2, 2, '2025-02-13 09:30:00', '2025-02-13 09:31:45',
 'Benigno', 0.85, 'THERMO_AI_V2.4', 'A1B2C3D4', 'IMGHASH2025BEN'),

(3, 3, '2025-02-14 10:15:00', '2025-02-14 10:16:10',
 'Cisto', 0.76, 'THERMO_AI_V2.3', 'E5F6G7H8', 'IMGHASH2025CIS');
...
(
 ...
 '/laudos/laudo_001.pdf',
 1, '192.168.0.10', 1, 'LD-0258-MAL-2025'
),
...
(
 ...
 '/laudos/laudo_002.pdf',
 1, '192.168.0.11', 1, 'LD-0392-BEN-2025'
);


----------------------------------------------------------
-- SEED: LAUDO_IMPRESSAO
----------------------------------------------------------
